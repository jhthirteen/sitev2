const Projects = () => {
    return(
        <div className="text-white">
            <h1 className="text-sky-500 font-bold">AI Powered Music Recommender</h1>
